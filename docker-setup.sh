...
echo ""
echo "  Changing path locations (Docker):"
echo "    Recording/log paths CAN be changed via Settings → Paths in"
echo "    the UI, but the new location must be one of the container's"
echo "    bind-mounted volumes. To record to a new host directory,"
echo "    edit $AUDIODECK_DIR/docker-compose.yml, add a new volume"
echo "    like   - /path/on/host:/app/my-recordings"
echo "    then point paths.recordings at /app/my-recordings in"
echo "    Settings → Paths and restart the stack."
echo ""
